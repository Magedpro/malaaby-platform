...
function defaultDb() {
  ...
  const pastSixtyDays = new Date(Date.now() - 60 * 24 * 60 * 60 * 1000).toISOString();
  ...
  return {
    ...
    stadiums: [
      {
        slug: 'stadium-maged-50',
        ownerId: 'user-maged-50',
        name: 'ملاعب الكابتن ماجد الرياضية',
        description: 'مجمع رياضي ممتاز متكامل بمركز القاهرة مع إضاءة ليلية ونجيلة صناعية معتمدة.',
        phone: '01126947405',
        whatsapp: '+201126947405',
        city: 'القاهرة',
        address: 'مدينة نصر، بجوار النادي الأهلي',
        ...
        vodafoneCash: '01126947405',
        instaPay: '01126947405',
        paymentInstructions: 'يرجى تحويل العمولات أو قيمة الحجز على فودافون كاش أو انستا باي 01126947405.',
        subscriptionPlanId: 'plan-pro',
        subscriptionStatus: 'active',
        commissionRate: 5,
        unpaidCommission: 30, // 6 completed bookings * 5 = 30 EGP
      ...
      },
      {
        slug: 'demo',
        ownerId: 'user-maged-admin',
        name: 'ملعب ديمو التجريبي',
        description: 'ملعب تجريبي لعرض تجربة الحجز على المنصة.',
        phone: '01126947405',
        whatsapp: '+201126947405',
        city: 'القاهرة',
        address: 'الحي الراقي، القاهرة الجديدة',
        googleMapsUrl: 'https://maps.google.com',
        logo: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=100&h=100&fit=crop',
        coverImage: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=1200&h=400&fit=crop',
        vodafoneCash: '01126947405',
        instaPay: '01126947405',
        paymentInstructions: 'يرجى استخدام الدفع عبر المحافظ الرقمية عند الحجز.',
        subscriptionPlanId: 'plan-pro',
        subscriptionStatus: 'active',
        commissionRate: 5,
        unpaidCommission: 0,
    ...
    fields: [
      {
        id: 'field-maged-50-1',
        stadiumSlug: 'stadium-maged-50',
        name: 'الملعب الذهبي الرئيسي (خماسي)',
        description: 'ملعب خماسي ترتان ممتاز مع إضاءة ليلية عالي الجودة.',
        pricePerHour: 200,
        bookingDuration: 60,
        openingTime: '08:00',
        closingTime: '23:00',
      ...
      },
      {
        id: 'field-demo-1',
        stadiumSlug: 'demo',
        name: 'الملعب التجريبي',
        description: 'ملعب تجريبي مناسب لعرض تجربة الحجز.',
        pricePerHour: 180,
        bookingDuration: 60,
        openingTime: '08:00',
        closingTime: '23:00',
    ...
    bookings: [
      {
        ...
        status: 'completed',
        createdAt: pastSixtyDays,
        updatedAt: pastSixtyDays,
      },
      {
        id: 'booking-maged-2',
        fieldId: 'field-maged-50-1',
        stadiumSlug: 'stadium-maged-50',
        customerName: 'مصطفى علي',
